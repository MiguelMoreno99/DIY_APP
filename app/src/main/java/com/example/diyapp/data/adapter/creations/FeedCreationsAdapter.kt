...
class feedCreationsAdapter(private val feedCreationsList: List<feedCreations>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): feedCreationsViewHolder {
        ...
        return feedCreationsViewHolder(layoutInflater.inflate(R.layout.item_feedcreations,parent,false))
    }
